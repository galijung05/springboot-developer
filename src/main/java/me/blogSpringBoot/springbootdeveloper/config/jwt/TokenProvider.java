...
public class TokenProvider {
    // 토큰을 생성하고 올바른 토큰인지 유효성 검사하고, 토큰에서 필요한 정보를 가져오는 클래스
    ...
    // 만료 시간, 유저 정보를 인자로 받는 JWT 토큰 생성 메서드
    private String makeToken(Date expiry, User user) {
        ...
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.ES256, jwtProperties.getSecretKey()) // 서명 (비밀값과 함께 해시값을 HS256 방식으로 암호화)
                .compact();
    }
    ...
    // 스프링 시큐리티에서 제공하는 객체인 User 클래스 사용
